...
## Ajustes pós-review da Arena

- o atalho flutuante da Arena recebeu posição e contraste reforçados, para não
  se perder entre os painéis do HUD;
- a Arena PvP passou a exibir, dentro do viewport, as barras autoritativas de
  vida e mana dos dois participantes;
- ranged começa a contornar a arena dois tiles antes da borda. O sentido de
  contorno é estável por combatente, preservando replay/restore determinísticos
  e preparando arenas futuras com obstáculos laterais;
- a ladder mantém o requisito de cinco partidas **ranqueadas** concluídas, mas
  agora explica o progresso de posicionamento e deixa explícito que duelos e
  partidas casuais não entram na temporada.

### Posturas x estratégia PvP

As posturas de expedição continuam sendo um sistema distinto da estratégia da
Arena. Elas alteram atributos derivados no PvE/offline (+35% ataque/-20%
defesa ou +50% defesa/-25% ataque), enquanto a Arena usa estratégia para
espaçamento, velocidade tática e limiar de cura. A remoção das posturas exige
uma etapa própria de rebalanceamento e migração para `balanced`; não foi feita
neste ajuste para não mudar silenciosamente o poder de personagens existentes.
