...
| Persistência | 26 arquivos de migration embutidos, até `000026_pvp_arena_lifecycle.sql` | `backend/migrations/`, `backend/internal/db/migrator.go` |
